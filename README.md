...
│       ├── main_Class.java          # Main transaction menu
...
│       ├── mini.java                # Recent transaction history
│       ├── Pin.java                 # PIN update
│       └── Connn.java               # MySQL database connection class
├── out/production/
...
- The `Connn.java` file holds your database credentials — do not commit it with real passwords if you fork this
